...
We instead outlined a general set of rules to determine syllables. These rules accurately determine the correct number of syllables in the majority of instances. For the purposes of our rules, y is counted as a vowel.
\begin{enumerate}
